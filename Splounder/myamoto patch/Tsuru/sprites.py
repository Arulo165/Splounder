...
class SpriteImage_Splounder(SLib.SpriteImage_Static):  # 901
    def __init__(self, parent):
        super().__init__(
            parent,
            3.75,
            ImageCache['splounder'],
            (-10, -19),
        )

    def loadImages():
        SLib.loadIfNotInImageCache('splounder', 'splounder.png')
